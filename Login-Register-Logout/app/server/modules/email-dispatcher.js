...
EM.server = require("emailjs/email").server.connect(
{
	...
	user 	    : process.env.NL_EMAIL_USER || 'kunalbidkar13@gmail.com',
	password    : process.env.NL_EMAIL_PASS || 'my_password',
	ssl		    : true
});
...
{
	EM.server.send({
		from         : process.env.NL_EMAIL_FROM || 'Kunal <do-not-reply@gmail.com>',
		to           : account.email,
